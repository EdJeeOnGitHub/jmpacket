...
% \newcommand{\fields}{development economics, applied econometrics}
% \newcommand{\onesenID}{understanding the dynamics and causes of persistent poverty in low-income countries}
% \newcommand{\threesenID}{ed}
%------------------------------------------------------------------------------%
\newcommand{\capfieldlist}{Development Economics, Applied Econometrics}
\newcommand{\fields}{development economics, applied econometrics}
\newcommand{\onesenID}{understanding the dynamics and causes of persistent poverty in low-income countries}
